    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-100 via-purple-50 to-blue-100 p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium">{user.job || "N/A"}</p>
                </div>
              </div>
            </div>
        ...
        <div className="md:col-span-2 space-y-6">
          ...
          {/* Recent Activity */}
          <div className="bg-white p-6 rounded-xl shadow-md">
            <h3 className="text-lg font-semibold text-gray-700 mb-8">Recent Activity</h3>
            <div className="space-y-4">
              {[1, 2, 3].map((item) => (
                <div key={item} className="flex items-center border-b border-gray-100 pb-3 last:border-0 last:pb-0">
